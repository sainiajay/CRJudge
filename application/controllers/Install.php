...
class Install extends CI_Controller
{
	...
	public function index()
	{
		...
		if ($this->form_validation->run()) {
			...
			$fields = array(
				'crj_key'        => array('type' => 'VARCHAR', 'constraint' => 50),
				//'crj_value'      => array('type' => 'TEXT', 'default' => ''),
				'crj_value'      => array('type' => 'TEXT'),
			);
			$this->dbforge->add_field($fields);
			$this->dbforge->add_key('crj_key');
			...
			$result = $this->db->insert_batch('settings', array(
				array('crj_key' => 'timezone',               'crj_value' => 'Asia/Tehran'),
				array('crj_key' => 'tester_path',            'crj_value' => '/home/shj/tester'),
				array('crj_key' => 'assignments_root',       'crj_value' => '/home/shj/assignments'),
				array('crj_key' => 'file_size_limit',        'crj_value' => '50'),
				array('crj_key' => 'output_size_limit',      'crj_value' => '1024'),
				array('crj_key' => 'queue_is_working',       'crj_value' => '0'),
				array('crj_key' => 'default_late_rule',      'crj_value' => "/* \n * Put coefficient (from 100) in variable \$coefficient.\n * You can use variables \$extra_time and \$delay.\n * \$extra_time is the total extra time given to users\n * (in seconds) and \$delay is number of seconds passed\n * from finish time (can be negative).\n *  In this example, \$extra_time is 172800 (2 days):\n */\n\nif (\$delay<=0)\n  // no delay\n  \$coefficient = 100;\n\nelseif (\$delay<=3600)\n  // delay less than 1 hour\n  \$coefficient = ceil(100-((30*\$delay)/3600));\n\nelseif (\$delay<=86400)\n  // delay more than 1 hour and less than 1 day\n  \$coefficient = 70;\n\nelseif ((\$delay-86400)<=3600)\n  // delay less than 1 hour in second day\n  \$coefficient = ceil(70-((20*(\$delay-86400))/3600));\n\nelseif ((\$delay-86400)<=86400)\n  // delay more than 1 hour in second day\n  \$coefficient = 50;\n\nelseif (\$delay > \$extra_time)\n  // too late\n  \$coefficient = 0;"),
				array('crj_key' => 'enable_easysandbox',     'crj_value' => '1'),
				array('crj_key' => 'enable_c_shield',        'crj_value' => '1'),
				array('crj_key' => 'enable_cpp_shield',      'crj_value' => '1'),
				array('crj_key' => 'enable_py2_shield',      'crj_value' => '1'),
				array('crj_key' => 'enable_py3_shield',      'crj_value' => '1'),
				array('crj_key' => 'enable_java_policy',     'crj_value' => '1'),
				array('crj_key' => 'enable_log',             'crj_value' => '1'),
				array('crj_key' => 'submit_penalty',         'crj_value' => '300'),
				array('crj_key' => 'enable_registration',    'crj_value' => '0'),
				array('crj_key' => 'registration_code',      'crj_value' => '0'),
				array('crj_key' => 'mail_from',              'crj_value' => 'shj@example.com'),
				array('crj_key' => 'mail_from_name',         'crj_value' => 'Sharif Judge'),
				array('crj_key' => 'reset_password_mail',    'crj_value' => "<p>\nSomeone requested a password reset for your Sharif Judge account at {SITE_URL}.\n</p>\n<p>\nTo change your password, visit this link:\n</p>\n<p>\n<a href=\"{RESET_LINK}\">Reset Password</a>\n</p>\n<p>\nThe link is valid for {VALID_TIME}. If you don't want to change your password, just ignore this email.\n</p>"),
				array('crj_key' => 'add_user_mail',          'crj_value' => "<p>\nHello! You are registered in Sharif Judge at {SITE_URL} as {ROLE}.\n</p>\n<p>\nYour username: {USERNAME}\n</p>\n<p>\nYour password: {PASSWORD}\n</p>\n<p>\nYou can log in at <a href=\"{LOGIN_URL}\">{LOGIN_URL}</a>\n</p>"),
				array('crj_key' => 'moss_userid',            'crj_value' => ''),
				array('crj_key' => 'results_per_page_all',   'crj_value' => '40'),
				array('crj_key' => 'results_per_page_final', 'crj_value' => '80'),
				array('crj_key' => 'week_start',             'crj_value' => '0'),
			));
			if ( ! $result)
